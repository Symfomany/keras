...
Difference between .meta files and .pbtxt files,
 ...
 But if you keep as_test = false it is no more human readable. Still they are different . .meta files holds ,more than just the structure of the graph like MetaInfoDef , GraphDef SaverDef , CollectionDef . Whereas .pbtxt files holds only the structure of the graph.
