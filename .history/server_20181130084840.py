...
app = Flask(__name__)
cors = CORS(app)
@app.route("/api/predict/<username>", methods=['POST'])
def predict():
    start = time.time()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--frozen_model_filename", default="models/models.ckpt/saved_model.pb", type=str, help="Frozen model file to import")
