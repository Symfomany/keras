...
This should just require a change at the importing stage e.g. instead of from keras.layers import Convolution2D you would have from tensorflow.keras.layers import Convolution2D.
