...
he methodology described in this article, although written specifically for converting a model written in the Keras API (natively or in the TensorFlow implementation), it can also be used for any model written in native TensorFlow as well.
